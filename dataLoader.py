...
def load_problem_from_file(file_path: str) -> ProblemDefinition:
    ...
    # --- 3. 将解析出的数据转换为NumPy数组并进行必要的重塑/转置 ---
    try:
        # P 和 E 矩阵在文件中是 (M x N) 格式
...
if __name__ == "__main__":
    # 示例用法
    file_path = "dataset\data_A3_J400_M4_2.txt"  # 替换为实际文件路径
    try:
